...
def launch(config: Config, args: argparse.Namespace) -> None:
    ...
    with data_loader_init():
        ...
        dataloader_packnet_base_retrain = None
        if config.dataloader_packnet_base_retrain is not None:
            dataset_base = instantiate(config.dataloader_packnet_base_retrain.dataset)
            ...
            dataloader_packnet_base_retrain = DataLoader(
                dataset=dataset_base,
                sampler=sampler_base,
                batch_size=config.dataloader_packnet_base_retrain.batch_size,
                drop_last=config.dataloader_packnet_base_retrain.drop_last,
                num_workers=config.dataloader_packnet_base_retrain.num_workers,
                persistent_workers=config.dataloader_packnet_base_retrain.persistent_workers,
                pin_memory=config.dataloader_packnet_base_retrain.pin_memory,
                pin_memory_device=config.dataloader_packnet_base_retrain.pin_memory_device,
                timeout=config.dataloader_packnet_base_retrain.timeout,
            )
    ...
    trainer.train(
        ...
        dataloader_train,
        dataloader_val,
        dataloader_packnet_base_retrain=dataloader_packnet_base_retrain,
    )
